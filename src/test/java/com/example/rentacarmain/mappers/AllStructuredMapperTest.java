...
//                BigDecimal.valueOf(3000), LocalDate.of(2020, 12, 23), modelRequest, ownerRequest, locationRequest);
//
//        var expected = new Advertisements(
//                null, "Tekerinde problem var",
//                BigDecimal.valueOf(3000), LocalDate.of(2020, 12, 23),
//                false, Location.builder().id(1L).build(), Model.builder().id(1L).build(),
...
//                BigDecimal.valueOf(3000), LocalDate.of(2020, 12, 23),
//                true, Location.builder().id(1L).build(), Model.builder().id(1L).build(),
//                Owners.builder().id(1L).build());
//
